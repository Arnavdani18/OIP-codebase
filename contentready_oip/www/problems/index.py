import frappe
from contentready_oip import api, problem_search
import json
...
def get_context(context):
    ...
    # For the search we match everything we can as we handle pagination at the 
    matched = problem_search.search_index('*', scope=scope, limit=10)
